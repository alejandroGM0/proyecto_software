...
ERROR_PAYMENT_PROCESSING = "Hubo un error al procesar el pago. Por favor, inténtalo de nuevo."
...
INFO_PAYMENT_VERIFYING = "El estado del pago está siendo verificado. Te notificaremos cuando se confirme."
