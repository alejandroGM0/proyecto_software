...
class ReportEndpointSecurityTests(TestCase):
    ...
    def test_unauthorized_access_to_report_detail(self):
        ...
        # Intentar acceder sin autenticación
        response = self.client.get(reverse(URL_REPORT_DETAIL, args=[self.user_report.id]))
    ...
    def test_unauthorized_update_of_others_report(self):
        ...
        response = self.client.post(
            reverse(URL_UPDATE_REPORT, args=[self.user_report.id]),
            update_data
        )
    ...
    def test_unauthorized_delete_of_others_report(self):
        ...
        response = self.client.post(reverse(URL_DELETE_REPORT, args=[self.user_report.id]))
    ...
    def test_unauthorized_mark_as_unread(self):
        ...
        response = self.client.get(reverse(URL_MARK_UNREAD, args=[self.answered_report.id]))
    ...
    def test_update_report_with_response(self):
        ...
        response = self.client.post(
            reverse(URL_UPDATE_REPORT, args=[self.answered_report.id]),
            update_data
        )
